...
def get_customer_info():
    ...
    return "Justin Moravec", "Number 101"


def take_order():
    """Collects category, number of tacos, meat, and add ons. Returns data."""
    # TODO: Capture meat (Chicken/Steak/al pastor/ etc...) and category (Coffee/Tea/Cocoa)
    pass


def calculate_total(order_data):
    """Calculates price based on taco number and add ons."""
...
def save_data_and_label(customer, total):
    ...
    # TODO: Write raw data for computer and formatted box for cook
    pass
